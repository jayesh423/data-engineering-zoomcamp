...
# python 06_spark_sql-cluster.py \
    # --input_green=data/pq/green/2020/* \
    # --input_yellow=data/pq/yellow/2020/* \
    # --output=data/report-2020 

# URL="spark://zoomcamp-new.us-west1-b.c.ny-rides-jpatel.internal:7077"
# spark-submit \
#     --master="${URL}" \
#     06_spark_sql-cluster.py \
...
# spark = SparkSession.builder.master("spark://zoomcamp-new.us-west1-b.c.ny-rides-jpatel.internal:7077").appName('test').getOrCreate()
